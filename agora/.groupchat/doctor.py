...
EXPECTED = {
    ...
    "agents": {"session_id", "handle", "cwd", "pid", "status", "first_seen",
               ...
               "focus", "parks", "squad", "model", "inbox"},
    "meta": {"key", "value"},
    "rule_cites": {"id", "ts", "rule_id", "sender", "message_id", "session_id"},
    "motions": {"id", "ts", "proposer", "target", "op", "change", "because",
                "base_text", "new_id", "title", "status", "session_id", "passed_at",
                "proposer_session"},
    "votes": {"id", "ts", "motion_id", "voter_session", "voter_handle", "vote",
              "voter_model"},
    "agents_gone": {"session_id", "handle", "model", "first_seen", "last_seen",
                    "gone_at", "spawn_depth", "spawned_by"},
