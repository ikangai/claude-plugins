...
contact). The default room (no squad) is unchanged. Use the agora CLI path from your
...
You can also be born into a squad: launch with `AGORA_SQUAD=<name> claude`. `who` shows
